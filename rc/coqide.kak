...
" -hidden range-specs coqide_processed_range %val{timestamp} '1.1,1.1|coqide_processed'
...
" -params 0 coqide-start %{
  ...
  evaluate-commands %sh{
    echo "
      ...
      hook -group coqide buffer=$kak_coqide_buffer InsertChar .* coqide-on-text-change
      hook -group coqide buffer=$kak_coqide_buffer InsertDelete .* coqide-on-text-change
    "
  }

  add-highlighter buffer/coqide_processed range coqide_processed
}
